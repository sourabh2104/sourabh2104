...
- **Harness & Loop Engineering:** Building evaluation harnesses, agentic coding tools (**Claude Code, Codex, Pi Agent**), and sandboxed execution environments for autonomous agent loops.
- **AI Security & Biometrics:** Engineered behavioral biometric ML engines (44D keystroke dynamics with 97% accuracy under sub-100ms latency) and real-time policy engines.
- **LLM Fine-Tuning & Reasoning:** Working with **Hermes**, reasoning LLMs, Transformers (MoE, RoPE, ViT), and CUDA/TensorRT acceleration.

---

### Tech Stack & Trending Capabilities
...
### Core Achievements
- **AI Compliance Framework Builder:** Reduced compliance framework rollout time from weeks to minutes using multi-agent RAG.
- **Biometric Security Engine:** Developed sub-100ms 44D keystroke dynamics authentication stopping credential-theft attacks.

---

 **Connect with me:**
-  Email: `sourabh1256@gmail.com`
-  [LinkedIn](https://linkedin.com/in/sourabh-yadav)
-  GitHub: [@sourabh2104](https://github.com/sourabh2104)
